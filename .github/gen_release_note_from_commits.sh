...

{
    ...
    if [[ "$version_range" == *...* ]]; then
        echo "**Full Changelog**: https://github.com/doraemonkeys/menv/compare/$version_range"
    else
        echo "**Full Changelog**: https://github.com/doraemonkeys/menv/commits/$version_range"
    fi
} >release.md
